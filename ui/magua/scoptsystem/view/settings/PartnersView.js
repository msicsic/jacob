define([
    ...
    "scoptsystem/dialog/settings/PartnerContactDialog",
    "scoptsystem/dialog/settings/PartnerAddressDialog",
    ...
    var messages = i18n.getLocalization("scoptsystem", "PartnersView");
    ...
    return declare([View, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        constructor: function() {
            ...
            this.partnersStore = new DataStore({
                message: "settings.business_partner_select"
            });
        ...
        _showPartner: function(partnerId) {
            ...
            connector.compoundCall([
                [
                    "settings.business_partner_select",
                    {
                        data: {id: this.partnerId}
                    }
                ], [
                    "settings.business_partner_media_contact_list",
                    {
                        data: {business_partner_id: this.partnerId}
                    }
                ], [
                ...
                self.updatePartnerIsCustomerInput.set("checked", data[0].is_customer);
                self.updatePartnerIsSupplierInput.set("checked", data[0].is_supplier);
            ...
            if (this.updatePartnerForm.validate()) {
                ...
                connector.call("settings.business_partner_create", {
                    ...
                    data: {
                        ...
                        is_customer: this.updatePartnerIsCustomerInput.get("checked"),
                        is_supplier: this.updatePartnerIsSupplierInput.get("checked")
                    }
                }).then(function(data) {
                    self._searchPartner();
        ...
        _showContact: function(partnerContact) {
            ...
            var dialog = new PartnerContactDialog({
                ...
                onContactChanged: function() {
                    connector.call("settings.business_partner_media_contact_list", {
                        data: {business_partner_id: self.partnerId}
                    }).then(function(data) {
                        self.mediaContactsStore.setData(data);
                        self.mediaContactsGrid.setQuery({});
                    });
        ...
        _createContact: function() {
            ...
            var dialog = new PartnerContactDialog({
                mode: "create",
                values: {
                    business_partner_id: this.partnerId
                },
                onContactChanged: function() {
                    connector.call("settings.business_partner_media_contact_list", {
                        data: {business_partner_id: self.partnerId}
        ...
        _updatePartner: function() {
            if (this.updatePartnerForm.validate()) {
                ...
                this.updatePartner.is_customer = this.updatePartnerIsCustomerInput.get("checked");
                this.updatePartner.is_supplier = this.updatePartnerIsSupplierInput.get("checked");

                var self = this;
                var parnerId = this.updatePartner.id;
                connector.call("settings.business_partner_update", {
                    sync: true,
