define([
    ...
    var messages = i18n.getLocalization("scoptsystem", "UnitOfMeasuresView");
    ...
    return declare([View, _TemplatedMixin, _WidgetsInTemplateMixin], {
            ...
            on(this.unitOfMeasuresGrid, "applyEdit", function(inRowIndex) {
                ...
                if (oldName !== item.name) {
                    MessageBoxDialog.question({
                        ...
                        if (btn === "yes") {
                            connector.call("settings.uom_update", {
                                sync: true,
                                data: {
                                    id: item.id,
        ...
        _create: function() {
            if (this.createForm.validate()) {
                var self = this;
                connector.call("settings.uom_create", {
                    sync: true,
                    data: {
